...
using ShareData.Models.TokenAuth;
...
{
    public abstract class ShareDataWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ShareDataWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ShareDataWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ShareDataDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ShareDataDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ShareDataDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ShareDataDbContext, Task<T>> func)
        {
            T result;
